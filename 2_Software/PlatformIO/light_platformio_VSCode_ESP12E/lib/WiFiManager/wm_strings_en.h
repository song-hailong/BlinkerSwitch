...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='a'>Auth</label><input id='a' name='a' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><label for='s'>SSID</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>Password</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'><input type='checkbox' onclick='f()'> Show Password"; //FIX MY
